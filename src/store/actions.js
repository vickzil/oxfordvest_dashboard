...
// Login
export const fetchRegistrationInfo = ({
    commit,
    state
}) => {
...
export const setAlertModalStatus = ({
    commit
}, status) => {
...
export const setVerifyAction = ({
    commit
}, status) => {
    commit('SET_VERIFY_ACTION', status);
};

export const setCurrentClickPayload = ({
    commit
}, status) => {
    commit('SET_CURRENT_CLICKED_PAYLOAD', status);
};

export const setFundWalletLoading = ({
    commit
}, payload) => {
...
export const paymentOptionsBack = ({
    commit
}) => {
...
export const setClickedPaymentType = ({
    commit
}, payload) => {
...
export const setCalCulateInvestmentModal = ({
    commit
}, payload) => {
...
export const storeCurrentInvestment = ({
    commit
}, payload) => {
    commit('STORE_CURRENT_INVESTMENT', payload);
};

export const investmentCategoryText = ({
    commit
}, payload) => {
    commit('INVESTMENT_CATEGORY_TEXT', payload);
};

export const setPerformInvestmentModal = ({
    commit
}, payload) => {
...
// WITHDRAW
export const setWithdrawalModal = ({
    commit
}, status) => {
