                        ...
                        <div class="form-group c_form_group">
                          ...
                          <select class="form-control">
                            ...
                            <optgroup label="Manual Offsets">
                              ...
                              <option selected="selected" value="UTC-5">
                                UTC-5
                              </option>
                          ...
                          <div class="fancy-radio">
                            <label
                              ><input
                                ...
                                value=""
                                type="radio"
                              /><span><i></i>May 18, 2018</span></label
                            >&nbsp;&nbsp;
                            <label
                              ><input
                                name="dateFormat"
                                value=""
                                type="radio"
                              /><span><i></i>2018, May, 18</span></label
                            >&nbsp;&nbsp;
                            <label
                              ><input
                                name="dateFormat"
                                ...
                                type="radio"
                                checked
                              /><span><i></i>2018-03-10</span></label
                            >&nbsp;&nbsp;
                            <label
                              ><input
                                name="dateFormat"
                                value=""
                                type="radio"
                              /><span><i></i>02/09/2018</span></label
                            >&nbsp;&nbsp;
                            <label
                              ><input
                                name="dateFormat"
                                value=""
                                type="radio"
                              /><span><i></i>10/05/2018</span></label
                            >
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-12 col-md-12">
                        ...
                        <ul class="list-unstyled list-email-received">
                          ...
                          <li>
                            <label class="fancy-checkbox">
                              <input type="checkbox" checked /><span
                                >Promotional news such as offers or
                                discounts</span
                              ></label
                            >
                          </li>
                          <li>
                            <label class="fancy-checkbox">
                              <input type="checkbox" checked /><span
                                >Tips for campaign setup, growth and client
